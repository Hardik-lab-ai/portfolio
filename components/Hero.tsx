    ...
    <section id="hero" className="hero-grid">
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(0,139,139,0.20) 0%, transparent 65%)",
        ...
        <div style={{
          ...
          color: "rgba(255,255,255,0.45)", fontWeight: 400, minHeight: "1.7rem", marginBottom: 40,
        ...
        <div style={{
          ...
          {[
            ...
            <div key={label} style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <span style={{ color: "rgba(255,255,255,0.38)", fontSize: 9.5, fontWeight: 700, letterSpacing: "0.12em", width: 56, flexShrink: 0 }}>{label.toUpperCase()}</span>
              <span style={{ width: 1, height: 11, background: "rgba(255,255,255,0.15)", flexShrink: 0 }} />
              <span style={{ color: "rgba(255,255,255,0.80)", fontSize: 13 }}>{value}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{ width: 18, height: 30, borderRadius: 9, border: "1.5px solid rgba(255,255,255,0.22)", display: "flex", justifyContent: "center", paddingTop: 4 }}>
            <div style={{ width: 2.5, height: 6, borderRadius: 2, background: "var(--accent)", animation: "fadeUp 1.5s ease-in-out infinite" }} />
          </div>
          <span style={{ color: "rgba(255,255,255,0.38)", fontSize: 9.5, letterSpacing: "0.14em", fontWeight: 600 }}>SCROLL</span>
        </div>
      </div>
      ...
      <div ref={rightRef} style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(0,139,139,0.10) 0%, transparent 70%)",
          filter: "blur(80px)", pointerEvents: "none",
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(193,104,32,0.07) 0%, transparent 70%)",
